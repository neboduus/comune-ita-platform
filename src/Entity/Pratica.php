...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PraticaRepository")
...
class Pratica implements IntegrabileInterface, PaymentPracticeInterface
{
    ...
    /**
     * @param string|array $numeroDiProtocollo
     *
     * @return Pratica
     */
    ...
    private function parseCommenti()
    {
        ...
        foreach ($data as $commentoSerialized) {
            $this->parseCommentStringIntoArrayCollection($commentoSerialized);
        }
    }
    ...
    public function getDelegaDataArray()
    {
        ...
        return \json_decode((string)$this->getDelegaData(), true);
    }
    ...
    {
        return \json_decode((string)$this->getPaymentData());
    }
