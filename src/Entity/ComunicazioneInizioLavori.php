 ...
 * @ORM\Entity
 */
class ComunicazioneInizioLavori extends Base
{
    ...
    {
        parent::__construct();
        $this->type = Pratica::TYPE_COMUNICAZIONE_INIZIO_LAVORI;
        $this->dematerializedForms = (new SciaPraticaEdilizia(['tipo'=> Pratica::TYPE_COMUNICAZIONE_INIZIO_LAVORI]))->toHash();
    }
