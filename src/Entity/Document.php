...
class Document
{
   ...
   * @ORM\Id
   * @OA\Property(description="Document's uuid", type="string", format="uuid")
   * @Groups({"read"})
   */
  private $id;
 ...
 * @OA\Property(description="Document's owner id", type="string")
 * @Serializer\Exclude()
 */
  private $owner;
   ...
   * @OA\Property(description="Document's folder id", type="string")
   * @Serializer\Exclude()
   */
  private $folder;
   ...
   * @OA\Property(description="Document's recipient type. Specifies whether the document has been uploaded tby the citizen or generated by the municipality. Accepts values: tenant, user", type="string", example="user")
   * @Groups({"read"})
   */
   ...
   * @OA\Property(description="Document's version, updated on document changes", type="integer")
   * @Groups({"read"})
   */
  private $version;
   ...
   * @OA\Property(description="Document's md5 (if provided it's used to check the validity of the document, it will be calculated on the provided document otherwise)", type="string")
   * @Groups({"read", "write"})
   */
  private $md5;
   ...
   * @OA\Property(description="Document's original file name", type="string")
   * @Groups({"read", "write"})
   */
   ...
   * @OA\Property(description="Document's mime type", type="string")
   * @Groups({"read", "write"})
   */
  private $mimeType;
   ...
   * @OA\Property(description="Document's url address. If both file and address are provided, file is kept", type="string", example="https://www.example.com/file")
   * @Groups({"read", "write"})
   */
  private $address;
   ...
   * @OA\Property(description="Document's download link. ", type="string", example="https://www.example.com/download-file")
   * @Groups({"read"})
   */
   ...
   * @OA\Property(description="Document's tenant id", type="string")
   * @Serializer\Exclude()
   */
  private $tenant;
   ...
   * @OA\Property(description="Document's title", type="string")
   * @Groups({"read", "write"})
   */
  private $title;
   ...
   * )
   * @OA\Property(description="Document's topics, relation to Category Entity", type="array", @OA\Items(type="string"))
   * @Serializer\Exclude()
   */
  private $topics;
   ...
   * @OA\Property(description="Document's description", type="string")
   * @Groups({"read", "write"})
   */
  private $description;
   ...
   * @OA\Property(description="Document's allowed readers (list of fiscal codes of users that are allowed to read the document)", type="array", @OA\Items(type="string"))
   * @Groups({"read", "write"})
   */
   ...
   * @OA\Property(description="Document's last read date")
   ...
   * @OA\Property(description="Document's downloads counter")
   * @Groups({"read"})
   */
   ...
   * )
   * @OA\Property(description="Document's validity begin date, after this date the document will have legal value")
   * @Groups({"read", "write"})
   */
   ...
   * @OA\Property(description="Document's validity end date, after this date the document will have no legal value")
   * @Groups({"read", "write"})
   */
  private $validityEnd;
   ...
   * @OA\Property(description="Document's expire date, after this date the document will not be available anymore")
   * @Groups({"read", "write"})
   */
  private $expireAt;
   ...
   * @OA\Property(description="Document's due date")
   * @Groups({"read", "write"})
   */
  private $dueDate;
   ...
   *      )
   * @OA\Property(description="Document's correlated services", type="array", @OA\Items(type="string"))
   * @Serializer\Exclude()
   */
   ...
   * @OA\Property(description="Document's creation date")
   * @Groups({"read"})
   */
  private $createdAt;
   ...
   * @OA\Property(description="Document's last modified date")
   * @Groups({"read"})
   */
  private $updatedAt;
   ...
   * @OA\Property(description="If the document should be saved in the filesystem")
   * @Groups({"read", "write"})
   */
  private $store;
 ...
 */
   ...
   * @OA\Property(description="Save document in filesystem", type="boolean")
   ...
   * @Serializer\Type("string")
   * @OA\Property(description="Base64 file to be imported", type="string")
