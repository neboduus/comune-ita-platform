...
class Meeting
{
    ...
    public function initMeeting(LifecycleEventArgs $args): void
    {
        ...
        if ($this->getCreatedAt() === null) {
            ...
            if (!$this->fiscalCode && !$this->user) {
                ...
                $em->flush();
                $this->user = $user;
            } elseif ($this->fiscalCode && !$this->user) {
     ...
     * @throws ORMException
     */
    public function checkQueue(LifecycleEventArgs $args): void
    {
     ...
     * @throws \Exception
     */
    public function checkSlot(LifecycleEventArgs $args): void
    {
        // Retrieve all meetings in the same time slot
        $em = $args->getEntityManager();
        ...
        $openingHours = $em->getRepository('App:OpeningHour')->findBy(['calendar' => $this->calendar]);
