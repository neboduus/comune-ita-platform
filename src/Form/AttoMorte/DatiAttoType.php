...
class DatiAttoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $helper->setGuideText('steps.atto_morte.dati_atto.guida_alla_compilazione', true);
        $helper->setStepTitle('steps.atto_morte.dati_atto.title', true);
        $helper->setDescriptionText('steps.atto_morte.dati_atto.guida_alla_compilazione', true);
        ...
        $builder
            ...
            ->add('nome_soggetto_certificato', TextType::class, [
                ...
                'label' => 'steps.atto_morte.dati_atto.nome_soggetto_certificato'
            ])
            ...
            ->add('cognome_soggetto_certificato', TextType::class, [
                ...
                'label' => 'steps.atto_morte.dati_atto.cognome_soggetto_certificato'
            ])

            ->add('related_cfs', TextType::class, [
                'required' => true,
                'label' => 'steps.atto_morte.dati_atto.cf_soggetto_certificato'
            ]);
