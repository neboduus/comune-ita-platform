    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        switch ($occupazione) {
            case CambioResidenza::OCCUPAZIONE_PROPRIETARIO:
                $helper->setGuideText(
                    'steps.cambio_residenza.tipologia_occupazione_dettaglio.guida_alla_compilazione.proprietario',
                    true
                );
                $builder
            ...
            case CambioResidenza::OCCUPAZIONE_LOCAZIONE:
                $helper->setGuideText(
                    'steps.cambio_residenza.tipologia_occupazione_dettaglio.guida_alla_compilazione.locazione',
                    true
                );
                $builder
            ...
            case CambioResidenza::OCCUPAZIONE_LOCAZIONE_ERP:
                $helper->setGuideText(
                    'steps.cambio_residenza.tipologia_occupazione_dettaglio.guida_alla_compilazione.locazione_erp',
                    true
                );
                $builder
            ...
            case CambioResidenza::OCCUPAZIONE_COMODATO:
                $helper->setGuideText(
                    'steps.cambio_residenza.tipologia_occupazione_dettaglio.guida_alla_compilazione.comodato',
                    true
                );
                $builder
                    ->add('contrattoAgenzia', TextType::class, [
            ...
            case CambioResidenza::OCCUPAZIONE_USUFRUTTO:
                $helper->setGuideText(
                    'steps.cambio_residenza.tipologia_occupazione_dettaglio.guida_alla_compilazione.usufruttuario',
                    true
                );
                $builder
            ...
            case CambioResidenza::OCCUPAZIONE_AUTOCERTIFICAZIONE:
                $helper->setGuideText(
                    'steps.cambio_residenza.tipologia_occupazione_dettaglio.guida_alla_compilazione.autocertificazione',
                    true
                );
                $builder
