...
class MeetingLifeCycleListener
{
    ...
    public function postPersist(LifecycleEventArgs $args)
    {
        ...
        if ($meeting instanceof Meeting) {
            ...
            } elseif ($status == Meeting::STATUS_APPROVED) {
                $userMessage = $this->translator->trans(
                    'meetings.email.new_meeting.approved',
                    [
                        'hour' => $hour,
                        'date' => $date,
    ...
    public function preUpdate(PreUpdateEventArgs $args)
    {
        ...
        if ($meeting instanceof Meeting) {
            ...
            } elseif ($statusChanged && $status == Meeting::STATUS_CANCELLED) {
            ...
            } elseif (!$statusChanged && $dateChanged && $status == Meeting::STATUS_APPROVED) {
            ...
            } elseif (!$statusChanged && !$dateChanged && $linkChanged && $status == Meeting::STATUS_APPROVED) {
