 ...
 */
class OperatoreAbilitaServizioCommand extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $operatoriRepo = $this->em->getRepository('App:OperatoreUser');
        /** @var OperatoreUser $user */
        $user = $operatoriRepo->findOneBy(['username' => $username]);
        if (!$user) {
