 ...
 * @ORM\DiscriminatorMap({"default" = "Allegato", "modulo_compilato" = "ModuloCompilato", "allegato_operatore" = "AllegatoOperatore", "risposta_operatore" = "RispostaOperatore", "allegato_scia" = "AllegatoScia", "richiesta_integrazione" = "RichiestaIntegrazione" })
