...
class CalendarsController extends Controller
{
  ...
  public function indexCalendarsAction(Request $request)
  {
    ...
    $items = $em->getRepository('AppBundle:Calendar')->findAll();
    ...
    $table = $this->createDataTable()
      ...
      //->add('title', TextColumn::class, ['label'=>'Titolo', 'searchable'=>true])
      ->add('owner', TextColumn::class, ['label' => 'Proprietario', 'field' => 'owner.username', 'searchable' => true])
