...
class PraticaStatusService
{
  ...
  public function __construct(EntityManager $entityManager, LoggerInterface $logger, EventDispatcherInterface $dispatcher)
  {
    ...
    $this->validChangeStatusList = [
      ...
      [Pratica::STATUS_DRAFT_FOR_INTEGRATION => Pratica::STATUS_PRE_SUBMITTED_AFTER_INTEGRATION],
      [Pratica::STATUS_PRE_SUBMITTED_AFTER_INTEGRATION => Pratica::STATUS_SUBMITTED_AFTER_INTEGRATION],
      [Pratica::STATUS_PRE_SUBMITTED_AFTER_INTEGRATION => Pratica::STATUS_PENDING_AFTER_INTEGRATION],
