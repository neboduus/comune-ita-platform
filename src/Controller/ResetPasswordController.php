...
class ResetPasswordController extends AbstractController
{
    ...
    public function __construct(ResetPasswordHelperInterface $resetPasswordHelper, InstanceService $instanceService)
    {
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address($this->instanceService->getMailSender(), $this->instanceService->getTenant()->getName()))
            ->to($user->getEmail())
