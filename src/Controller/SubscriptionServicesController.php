...
class SubscriptionServicesController extends Controller
{
  ...
  public function indexSubscriptionServiceAction(Request $request)
  {
    ...
    $table = $this->dataTableFactory->create()
      ->add(
        ...
        [
          'label' => 'Nome',
          'propertyPath' => 'Nome',
          'render' => function ($value, $subscriptionService) {
            return sprintf(
              '<a href="%s">%s</a>',
              $this->generateUrl(
      ...
      ->add(
        ...
        ['label' => 'Data di inizio', 'format' => 'd/m/Y', 'searchable' => false]
      )
    ...
    return $this->render(
      'SubscriptionServices/indexSubscriptionService.html.twig',
      array(
        'user' => $user,
        'items' => $items,
        'statuses' => $statuses,
  ...
  public function newSubscriptionServiceAction(Request $request)
  {
    ...
    return $this->render(
      'SubscriptionServices/newSubscriptionService.html.twig',
      array(
        'user' => $user,
  ...
  public function deleteSubscriptionServiceAction(Request $request, SubscriptionService $subscriptionService)
  {
    try {
      ...
      $this->addFlash(
        'warning',
        'Impossibile eliminare il servizio a sottoscrizione, ci sono delle iscrizioni collegate.'
      );
  ...
  public function editSubscriptionServiceAction(Request $request, SubscriptionService $subscriptionService)
  {
    ...
    return $this->render(
      'SubscriptionServices/editSubscriptionService.html.twig',
      [
        'user' => $user,
        'form' => $form->createView(),
      ]
  ...
  public function showSubscriptionServiceAction(Request $request, SubscriptionService $subscriptionService)
  {
    ...
    return $this->render(
      'SubscriptionServices/showSubscriptionService.html.twig',
      array(
        'user' => $user,
        'subscriptionService' => $subscriptionService,
  ...
  private function createDeleteForm(SubscriptionService $subscriptionService)
  {
    return $this->createFormBuilder()
      ->setAction(
        $this->generateUrl('operatori_subscription-service_delete', array('id' => $subscriptionService->getId()))
      )
      ->setMethod('DELETE')
      ->getForm();
  }
