...
class SubscriptionServicesController extends Controller
{
     ...
     */
    public function indexSubscriptionService(Request $request, DataTableFactory $dataTableFactory)
    {
        $statuses = [
        ...
        $table = $dataTableFactory->create()
            ->add('name', TextColumn::class, ['label' => 'Nome', 'propertyPath' => 'Nome', 'render' => function ($value, SubscriptionService $subscriptionService) {
            ...
            ->add('subscriptions', TextColumn::class, ['label' => 'Iscrizioni', 'render' => function ($value, SubscriptionService $subscriptionService) {
                if ($subscriptionService->getSubscribersLimit()) {
                    return sprintf(
                        '<a href="%s">%s</a>',
                        $this->generateUrl(
                            'operatori_subscriptions',
                            ['subscriptionService' => $subscriptionService->getId()]
                        ),
     ...
     */
    public function newSubscriptionService(Request $request)
    {
     ...
     */
    public function deleteSubscriptionService(Request $request, SubscriptionService $subscriptionService)
    {
        try {
            $em = $this->getDoctrine()->getManager();
     ...
     */
    public function editSubscriptionService(Request $request, SubscriptionService $subscriptionService)
    {
        $form = $this->createForm('App\Form\SubscriptionServiceType', $subscriptionService);
        $form->handleRequest($request);
     ...
     * @return Response
     */
    public function showSubscriptionService(Request $request, SubscriptionService $subscriptionService)
    {
