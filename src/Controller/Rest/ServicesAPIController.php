 ...
 * @MustHaveTenant()
 */
class ServicesAPIController extends TenantAwareFOSRestController
{
     ...
     * @return \FOS\RestBundle\View\View
     */
    public function getFormService($id)
    {
        try {
            $repository = $this->getDoctrine()->getRepository('App:Servizio');
            ...
            $response = $this->formserver->getForm($service->getFormIoId());
     ...
     * @return \FOS\RestBundle\View\View
     */
    public function postService(Request $request, InstanceService $instanceService)
    {
     ...
     * @return \FOS\RestBundle\View\View
     */
    public function putService($id, Request $request)
    {
        /*try {*/
        $repository = $this->getDoctrine()->getRepository('App:Servizio');
        /** @var Servizio $service */
     ...
     * @return \FOS\RestBundle\View\View
     */
    public function patchService($id, Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $repository = $this->getDoctrine()->getRepository('App:Servizio');
        /** @var Servizio $service */
    ...
    /**
     * Delete a Service
     * @Rest\Delete("/{id}", name="services_api_delete", methods={"DELETE"})
     *
     * @SWG\Response(
     *     response=204,
