 ...
 */
final class Version20191215103814 extends AbstractMigration
{
    public function up(Schema $schema): void : void
    {
        ...
        $this->addSql('ALTER TABLE ente ADD gateways TEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void : void
    {
        ...
        $this->addSql('ALTER TABLE ente DROP gateways');
    }
}
