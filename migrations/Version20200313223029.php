 ...
 */
final class Version20200313223029 extends AbstractMigration
{
    public function up(Schema $schema): void : void
    {
        ...
        $this->addSql('ALTER TABLE ente ADD backoffice_enabled_integrations JSON DEFAULT NULL');
    ...
    public function down(Schema $schema): void : void
    {
        ...
        $this->addSql('ALTER TABLE ente DROP backoffice_enabled_integrations');
    }
}
