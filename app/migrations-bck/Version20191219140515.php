 ...
 */
final class Version20191219140515 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE subscription (id UUID NOT NULL, subscriber_id UUID NOT NULL, code VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, PRIMARY KEY(id))');
