...
class ContributoAssociazioniTest extends AbstractAppTestCase
{
    ...
    public function testICanFillOutTheContributoAssociazioniAsLoggedUser()
    {
        ...
        // servizio
        $servizio = $this->createServizioWithEnte($ente, 'Erogazione contributo associazioni', $fqcn, $flow);
        ...
        $this->assertEquals('Modulo ' . $currentPratica->getServizio()->getName() . ' compilato il ' . $submissionDate->format('d/m/Y h:i'),
