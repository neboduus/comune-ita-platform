...
| SENTRY_TRACES_SAMPLE_RATE  | No       |                                     | A number between 0 and 1. With this option set of percentage chance of a transaction being sent to Sentry. (So, for example, if you set traces_sample_rate to 0.2, approximately 20% of your transactions will get recorded and sent.) |
