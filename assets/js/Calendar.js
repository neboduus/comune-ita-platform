                        ...
                        self.calendar = self.container.find('.date-picker').datepicker({
                            ...
                            onSelect: function (dateText) {
                                ...
                                if (self.meeting_expiration_time) {
                                    ...
                                    $('#draft-expiration').html(`<i>Ti è stato riservato un appuntamento in bozza all'orario sopra indicato valido fino al giorno ${expiration}. Procedi con l'invio della domanda prima della scadenza per confermare l'appuntamento e non perdere la priorità per il giorno e l'orario selezionati</i>`)
                                }
