/**
 * Leaflet.BeautifyIcon, a plugin that adds colorful iconic markers for Leaflet
 * by giving full control of style to end user.
 * It has also ability to adjust font awesomeand glyphicon icons
 *
 * http://leafletjs.com
 */
  ...
  L.BeautifyIcon = {
    Icon: L.Icon.extend({
      ...
      createIconInnerHtml() {
        ...
        return `<i class="${options.prefix} ${options.iconPrefix}-${options.icon}${spinClass}" style="${innerIconStyle}"></i>`;
      },
